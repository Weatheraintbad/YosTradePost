...
### 贸易站(Trade Post) yostradepost:tradepost 在创造模式下位于原版实用方块栏，可使用红色羊毛、白色羊毛、任意类型木板和木桶合成。
Trade Post (yostradepost:tradepost) is located in the original utility block bar in Creative mode and can be crafted using red wool, white wool, any type of plank, and barrel.
